...
class ResizablePage(BasePage):
    ...
    def change_size_resizable_box(self):
        ...
        max_size = self.get_px_from_width_and_height(self.get_max_and_min_size(self.locators.RESIZABLE_BOX))
        self.action_drag_and_drop_by_offset(self.element_is_present(self.locators.RESIZABLE_BOX_HANDLE), -400, -200)
        min_size = self.get_px_from_width_and_height(self.get_max_and_min_size(self.locators.RESIZABLE_BOX))
    ...
    def change_size_resizable(self):
        ...
        min_size = self.get_px_from_width_and_height(self.get_max_and_min_size(self.locators.RESIZABLE))
        return max_size, min_size
...
class DroppablePage(BasePage):
    ...
    def drop_accept(self):
        ...
        drop_text_not_accepted = drop_div.text
        self.action_drag_and_drop_to_element(acceptable_div, drop_div)
        drop_text_accepted = drop_div.text
        return drop_text_not_accepted, drop_text_accepted
