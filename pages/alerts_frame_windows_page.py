...
from locators.allerts_frame_windows_locators import BrowserWindowsPageLocators, AlertsPageLocators, FramesPageLocators, \
...
class AlertsPage(BasePage):
    ...
    @allure.step("See Alert")
    def check_see_alert(self):
        self.element_is_visible(self.locators.SEE_ALERT_BUTTON).click()
        alert_window = self.driver.switch_to.alert
        return alert_window.text

    @allure.step("Alert Appears After Five Sec")
    def check_alert_appears_after_five_sec(self):
        self.element_is_visible(self.locators.APPEAR_ALERT_AFTER_FIVE_SECOND_BUTTON).click()
        time.sleep(5)
        try:
            alert_window = self.driver.switch_to.alert
            return alert_window.text
...
class ModalDialogsPage(BasePage):
    ...
    @allure.step("Modal dialogs")
    def check_modal_dialogs(self):
        self.element_is_visible(self.locators.SMALL_MODAL_BUTTON).click()
        title_small = self.element_is_visible(self.locators.TITLE_MODAL).text
        ...
        title_large = self.element_is_visible(self.locators.TITLE_MODAL).text
